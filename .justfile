...
@install-pkg:
    ...
    sudo apt-get -y -q=5 install firefox-esr firefox-esr-l10n-fr qimgv greetd "fonts-hack*" fonts-agave pulseaudio-utils trash-cli pulseaudio pavucontrol rofi greetd p7zip-full foot clang clangd "hypr*" waybar npm
